...
audio_features_labelled = pd.read_csv(
    os.path.join(raw_audio_path, "audio_features_labelled.csv"),
    index_col=["index", "file"],
)
...
audio_features_labelled_test.to_csv(
    os.path.join(raw_audio_path, "audio_features_labelled_test.csv"), index=True
)
